...
export default class AppComponent extends Component {
  ...
  handleSubmit(event) {
    ...
    fetch(`api/${this.state.targetHandle}/${encodedTerm}`, {
      credentials: "include",
    })
      .then(
  ...
  renderError() {
    if (this.state.errorMessage) {
      return (
        <h1 className="alert alert-danger"> {this.state.errorMessage} </h1>
      );
    }
  }
        ...
        <div className="marginCenter">
          <form className="form-inline" onSubmit={this.handleSubmit}>
            ...
            <div className="input-group mb-2 mr-sm-2 mb-sm-0">
              ...
              <input
                type="text"
                className="form-control inlineFormInputGroup"
                name="targetHandle"
                placeholder="Handle"
                onChange={this.handleInputChange}
                required
              />
              <small className="underHelp">
                {" "}
                User should have under 75k followers.
              </small>
            </div>
            ...
            <input
              type="text"
              className="form-control mb-2 mr-sm-2 mb-sm-0 inlineFormInputGroup"
              name="targetTerm"
        ...
        <div className="jumbotron jumbotron-fluid col-md-8 centric">
          <div className="container">
            ...
            <h5 className="lead">
              ...
              <a href="https://www.theoutline.com" target="_blank">
                The Outline
              </a>
              .*
            </h5>
            ...
            <div className="row marginCenter">{this.renderForm()}</div>
          </div>
          <div className="row marginCenter notes">
            <p className="col-md-8 rateNotice">
              *This tool is subject to rate limiting by Twitter.
            </p>
            <div className="col-md-4 tipjar">
              <a
                className="btn btn-outline-success btn-sm"
                href="https://PayPal.Me/lu2moons"
                target="_blank"
                role="button"
              >
                Tip Jar
      ...
      <tbody>
        {followers.map((follower, i) => (
          <tr key={i}>
            ...
            <td>
              <a
                href={`https:\/\/www.twitter.com/${follower.userHandle}`}
                target="_blank"
              >
                {`@${follower.userHandle}`}
              </a>
